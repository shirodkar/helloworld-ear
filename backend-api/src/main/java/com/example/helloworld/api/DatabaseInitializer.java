...
public class DatabaseInitializer {
    ...
    private boolean isDatabaseEmpty() {
        Long greetingCount = (Long) entityManager.createQuery("SELECT COUNT(g) FROM Greeting g").getSingleResult();
    ...
    private void populateGreetings() {
        Greeting[] greetings = {
                ...
                new Greeting("Welcome to the Hello World Application!"),
                new Greeting("Greetings from Jakarta EE 10!"),
                new Greeting("Happy to see you here!"),
                new Greeting("Let's build something awesome!")
        };
        ...
        entityManager.flush();
        logger.info("Inserted " + greetings.length + " sample greetings");
    }
