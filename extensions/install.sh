...
MYSQL_JAR_SOURCE="$PROJECT_ROOT/backend-api/target/module-jars/mysql-connector-java-8.0.33.jar"
cp "$MYSQL_JAR_SOURCE" "$MYSQL_MODULE_DIR/mysql-connector-java-8.0.33.jar"