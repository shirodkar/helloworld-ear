...
MYSQL_JAR_SOURCE="$PROJECT_ROOT/backend-api/target/module-jars/mysql-connector-j-9.7.0.jar"
cp "$MYSQL_JAR_SOURCE" "$MYSQL_MODULE_DIR/mysql-connector-j-9.7.0.jar"